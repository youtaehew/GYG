...
int main()
{
	...
	//0
	{
		...
		strcpy_s(arrMap[0][15], "11111113313313311111");
	...
	//4
	{
		...
		strcpy_s(arrMap[4][2], "10010010010010010000");
		strcpy_s(arrMap[4][3], "33333333333333333330");
		strcpy_s(arrMap[4][4], "00000000000000000000");
		strcpy_s(arrMap[4][5], "05555555555555555555");
		strcpy_s(arrMap[4][6], "33333333330333333333");
		strcpy_s(arrMap[4][7], "33333333330333333333");
		strcpy_s(arrMap[4][8], "33333333330333333333");
		strcpy_s(arrMap[4][9], "00000000000000000000");
		strcpy_s(arrMap[4][10], "00000000000000000000");
		strcpy_s(arrMap[4][11], "00000000000000000000");
		strcpy_s(arrMap[4][12], "00000000000000000000");
		strcpy_s(arrMap[4][13], "00000000000000220000");
		strcpy_s(arrMap[4][14], "00000002000002002000");
		strcpy_s(arrMap[4][15], "00000000200020000200");
		strcpy_s(arrMap[4][16], "00000000020200000020");
		strcpy_s(arrMap[4][17], "00000000002000000002");
		strcpy_s(arrMap[4][18], "00000000004000000002");
